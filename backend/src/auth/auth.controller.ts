...
export class AuthController {
  ...
  @Patch('update/:id_user') // Perhatikan bahwa saya mengubah ':id_user' dari Param
  async update(@Body() data: UpdateUserDto, @Param('id_user') idUser: number) {
    return await this.authService.update(+idUser, data);
  }
